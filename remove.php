...
<body>
	...
	<div id="mainContent">
		<h1 id="pageTitle">Welcome to the remove page <?php echo $_SESSION["uname"]; //Displays username ?></h1>
		<p id="mainPara">This page shows all of the information in the table and allows the
		user to remove an entry. For them to remove the entry they have to type the dog breed
		name into the box. When a valid breed is in the box press submit and all information
		associated to that breed will be removed from the database.</p>

		<!--Creating the form to allow input of required information-->
		<form class="removeform" method="post" name="register" action="removefunction.php">
			<!--Creating a label and input box for the dogbreed-->
			<label class="addbox" for="remove">Breed to remove (Capital Sensitive)<br> </label>
			<input class="addbox" type="text" name="dogbreedremove" required><br><br>

			<!--Creating a button to submit all information to removefunction.php-->
